...
//val v6: Boolean = FALSE //true и false только строчными буквами
val v7: Char = 'c'
val v8: Int = 500
...
//val v13: String = "true" //если требуется булево значение, надо убрать кавычки
...
//val v30: Boolean = FALSE //false с маленькой
val v31: Float = 0.007
//val v32: String = “🤯” //кавычки
val v33: Map<Boolean, Int> = mapOf("true" to 2, "false" to 34)
//val v34: String = ‘65535’ //кавычки
val v35: Long = 72057594037927935L
val v36: Float = 2.71828f
val v37: Float = 101.0101
...
//val v44: Boolean = TRUE //с маленькой буквы
